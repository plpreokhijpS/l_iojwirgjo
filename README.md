...
----------------------------------------- Gui Go
    ...
    local Tap6 = Window:Taps("Credit")
    
    local Hop_Sword = Tap1:newpage()
    local Hop_Weapon = Tap1:newpage()
	...
	local page8 = Tap3:newpage()
	local page9 = Tap6:newpage()
	
	page9:Label("Discord : Liver Hub")
	page9:Button("Copy Link! Discord",function()
	    setclipboard("https://discord.gg/mk5xThDKyP")
	end)
	function TPSever()
    game.StarterGui:SetCore("SendNotification", {
    Title = "Liver Hub"; -- the title (ofc)
    Text = "คนเยอะเกิน กำลังย้ายเซิฟ"; -- what the text says (ofc)
    Icon = "rbxassetid://57254792"; -- the image if u want. 
    Duration = 35; -- how long the notification should in secounds 
    })
end


	Hop_Sword:Label("Hop Boss")
	-- _G.Godof _G.FlameBoss _G.SwordMan _G.Tree _G.Factory _G.SeaBeats
	Hop_Sword:Button("Hop Sea Beast",function()
	    if _G.SelectWeapon == nil then
	        ...
	        setclipboard("_G.SeaBeats = true\n_G.Hop = true \n_G.SelectWeapon =".."'".._G.SelectWeapon.."'")
	        Sec()
	    end
	end)
	Hop_Sword:Button("Hop TreeMonster",function()
	    if _G.SelectWeapon == nil then
	        Not()
	        Not()
	        Not()
	        ...
	        setclipboard("_G.Tree = true\n_G.Hop = true \n_G.SelectWeapon =".."'".._G.SelectWeapon.."'")
	        Sec()
	    end
	end)
	Hop_Sword:Button("Hop FlameBoss",function()
	    if _G.SelectWeapon == nil then
	        Not()
	        Not()
	        Not()
	        ...
	        setclipboard("_G.FlameBoss = true\n_G.Hop = true \n_G.SelectWeapon =".."'".._G.SelectWeapon.."'")
	        Sec()
	    end
	end)
	Hop_Sword:Button("Hop SwordMan",function()
	    if _G.SelectWeapon == nil then
	        Not()
	        Not()
	        Not()
	        ...
	        setclipboard("_G.SwordMan = true\n_G.Hop = true \n_G.SelectWeapon =".."'".._G.SelectWeapon.."'")
	        Sec()
	    end
	end)
	Hop_Sword:Button("Hop God Of Light",function()
	    if _G.SelectWeapon == nil then
	        Not()
	        Not()
	        Not()
	        ...
	        setclipboard("_G.Godof = true\n_G.Hop = true \n_G.SelectWeapon =".."'".._G.SelectWeapon.."'")
	        Sec()
	    end
	end)
	Hop_Sword:Button("Hop Factory",function()
	    if _G.SelectWeapon == nil then
	        Not()
	        Not()
	        Not()
...
spawn(function()
    while wait(15) do
        if _G.DL then
            ...
            for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
                if v:IsA("Tool") then
                    for i2,v2 in pairs(v.Script:GetChildren()) do
    ...
    local Hop_SelectWeapon = Hop_Weapon:Drop("Select Weapon",false,Wapon,function(Value)
		_G.SelectWeapon = Value
		Wea()
	end)
	...
	Hop_Weapon:Button("Refresh Weapon",function()
	    EP = false
	    _G.SelectWeapon = nil
	...
	Hop_Sword:Line()
	Hop_Sword:Label("Hop Sword")
	
	Hop_Sword:Button("Hop Saber",function()
	    Next()
	end)
	Hop_Sword:Button("Hop Shisui",function()
	    if _G.SelectWeapon == nil then
	        Not()
	        Not()
	        Not()
	        ...
	        setclipboard("_G.Shisui = true\n_G.Hop = true\n_G.SelectWeapon =".."'".._G.SelectWeapon.."'")
	        Sec()
	    end
	end)
	Hop_Sword:Button("Hop Pole",function()
	    Next()
	end)
	--------------------------------------------------------------------------------------------------------------page
	Hop_Weapon:Line()
	Hop_Sword:Line()
	Hop_Sword:Label("Hop Fruit")
	Hop_Sword:Button("Hop Fruit + Eat",function()
	    if _G.SelectFruit == nil then
	        Fot()
	        Fot()
	        Fot()
	    else
	        setclipboard("_G.Hop_Fruit = true\n_G.Hop = true\n_G.SelectFruit =".."'".._G.SelectFruit.."'")
	        Sec()
	    end
	end)
	local All_Fruit = { "Tori","Mera" , "Goro" , "Soro" , "Mera" , "Gura" , "Pika" , "Mochi" , "Zushi" , "Magu" , "Hie" , "Bisu" , "Yami" , "Barrier" , "Bomu" , "Smoke" , "Sand" , "Yomi" , "Guru" , "Suke" }
	
	local Select_Fruit_Hop = Hop_Weapon:Drop("Select Fruit",false,All_Fruit,function(Value)
		_G.SelectFruit = Value
	end)
    
	Hop_Weapon:Button("Refresh Fruit",function()
		Select_Fruit_Hop:Clear()
		wait(0.2)
		for i,v in pairs(All_Fruit_No) do
		    Select_Fruit_No:Add(v)
		end
	end) 
...
page3:Toggle("Auto SeaBeats",_G.SeaBeats,function(vu)
    _G.SelectBoss = "Sea Beast"
...
page3:Toggle("Auto Factory",_G.Factory,function(vu)
    _G.SelectBoss = "Factory"
    _G.Auto_Farm_Boss = vu
end)
if _G.Tree then
else
...
page3:Toggle("Auto TreeMonster",_G.Tree,function(vu)
    _G.SelectBoss = "TreeMoster"
    _G.Auto_Farm_Boss = vu
end)
if _G.SwordMan then
else
...
page3:Toggle("Auto Sword Man",_G.SwordMan,function(vu)
    _G.SelectBoss = "Sword Man [Boss]"
    _G.Auto_Farm_Boss = vu
end)
if _G.Godof then
else
...
page3:Toggle("Auto God Of Light",_G.Godof,function(vu)
    _G.SelectBoss = "God Of Lighting"
    _G.Auto_Farm_Boss = vu
end)
if _G.FlameBoss then
    _G.FlameBoss = true
else
    _G.FlameBoss = false
end
page3:Toggle("Auto Flame Emperor",_G.FlameBoss,function(vu)
...
page10:Toggle("Auto Fruit Sniper",false,function()
    _G.Hop_Fruit = true
end)

	local All_Fruit_No = { "Tori","Mera" , "Goro" , "Soro" , "Gura" , "Pika" , "Mochi" , "Zushi" , "Magu" , "Hie" , "Bisu" , "Yami" , "Barrier" , "Bomu" , "Smoke" , "Sand" , "Yomi" , "Guru" , "Suke" }
	
	local Select_Fruit_No = page10:Drop("Select Fruit",false,All_Fruit_No,function(Value)
		_G.SelectFruit = Value
	end)
    
	page10:Button("Refresh Fruit",function()
		Select_Fruit_No:Clear()
		wait(0.5)
		for i,v in pairs(All_Fruit_No) do
		    Select_Fruit_No:Add(v)
		end
...
--------------------------------------------------------------------------------------------------------------page
	page2:Label("AutoStats") ----------------------------------------- Page 2


	_G.Melee = false
	page2:Toggle("Melee",_G.Melee,function(Value)
		_G.Melee = Value    
	end)
	_G.Defense = false
	page2:Toggle("Defense",_G.Defense,function(value)
		_G.Defense = value
	end)

	_G.Sword = false
	page2:Toggle("Sword",_G.Sword,function(value)
		_G.Sword = value
	end)

	_G.Fruit = false
	page2:Toggle("Devil Fruit",_G.Fruit,function(value)
		_G.Fruit = value
	end)
    
    _G.SelectPoint = 1
	page2:Slider("Point",false,false,1,50,_G.SelectPoint,1,3,function(t)
		_G.SelectPoint = t
	end)
...
spawn(function()
	while wait(.1) do
		if _G.Melee then
			game:GetService("ReplicatedStorage").okStats:FireServer(_G.SelectPoint,"1")
		end
	end
end)
...
spawn(function()
	while wait(.1) do
		if _G.Defense then
			game:GetService("ReplicatedStorage").okStats:FireServer(_G.SelectPoint,"3")
		end
	end
end)
...
spawn(function()
	while wait(.1) do
		if _G.Sword then
			game:GetService("ReplicatedStorage").okStats:FireServer(_G.SelectPoint,"2")
		end
	end
end)
spawn(function()
	while wait(.1) do
		if _G.Fruit then
			game:GetService("ReplicatedStorage").okStats:FireServer(_G.SelectPoint,"4")
		end
	end
end)

----------------------------------------- Island
page4:Label("Teleport Map")
page4:Button("Start Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(374.57824707031, 40.559078216553, -1861.0710449219)
end)
page4:Button("Carnival Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1572.4154052734, 30.035617828369, 602.40362548828)
end)
page4:Button("Rock Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2167.1188964844, 17.310565948486, -2714.3291015625)
end)
page4:Button("justical Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2600.3395996094, 22.901453018188, 280.79306030273)
end)
page4:Button("Chef Ship Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1137.9102783203, 123.45861053467, -5243.701171875)
end)
page4:Button("FishMan Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(4965.5883789062, 233.24732971191, 1960.8848876953)
end)
page4:Button("Snow Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2435.0263671875, 18.879720687866, 4539.7094726562)
end)
page4:Button("Sky Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-172.31398010254, 293.66354370117, 3603.498046875)
end)
page4:Button("Banadian Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3123.1137695312, 104.62505340576, -2510.662109375)
end)
page4:Button("Factory Island",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-74.932510375977, 20.549995422363, -8984.98046875)
end)
...
spawn(function()
    while wait(0.3) do 
        pcall(function()
            if Clip == true or _G.Auto_Farm or _G.Auto_Farm_Boss then
...
function CheckQuest()
    ...
    elseif Lv >= 30 and Lv < 60 then
        _G.Ms = "BagyPirates [Lv:30]"
        Qn = "BagyPirates"
    elseif Lv >= 60 and Lv < 150 then
        _G.Ms = "Clown Pirate [Lv:60]"
        Qn = "Clown Pirate"
    elseif Lv >= 150 and Lv < 200 then
        _G.Ms = "Revolutionary Troop [Lv:150]"
        Qn = "Revolutionary Troop"
    elseif Lv >= 200 and Lv < 500 then
        _G.Ms = "Marines [Lv:200]"
        Qn = "Marines"
    elseif Lv >= 500 and Lv < 600 then
       _G.Ms = "Marines [Lv:200]"
        Qn = "Marines"
    elseif Lv >= 600 and Lv < 700 then
        _G.Ms = "Fishman [Lv:600]"
        Qn = "Fishman"
    elseif Lv >= 700 and Lv < 850 then
        _G.Ms = "WinterBandit [Lv:700]"
        Qn = "WinterBandit"
    elseif Lv >= 850 and Lv < 950 then
        _G.Ms = "Sky Bandit [Lv:850]"
        Qn = "Sky Bandit"
    elseif Lv >= 950 and Lv < 1150 then
        _G.Ms = "Sky Bandit [Lv:850]"
        Qn = "Sky Bandit"
    elseif Lv >= 1150 and Lv < 1200 then
        ...
        pcall(function()
            if _G.Auto_Farm_Boss then
                if game:GetService("Workspace").Lives:FindFirstChild(_G.SelectBoss) then
                    ...
                    print(_G.SelectBoss)
                    wait(10)
                    if not game:GetService("Workspace").Lives:FindFirstChild(_G.SelectBoss) and _G.Hop == true then
                        Teleport()
                    end
                end
            end
...
page7:Button("Buy Haki",function()
    game:GetService("ReplicatedStorage").BuySpecial:InvokeServer("BusoHaki")
end)
page7:Button("Buy Ken",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-6276.5288085938, 32.993175506592, 3838.0651855469)
end)
page7:Button("Buy ColorHaki",function()
    game:GetService("ReplicatedStorage").HakiColour:InvokeServer()
end)

--page7:Line()

page7:Label("BuyMelee")



page7:Button("Buy FishmanKarate",function()
    game:GetService("ReplicatedStorage").BuyFS:InvokeServer("FishmanKarate")
end)

page7:Button("Buy Blackleg V1",function()
    game:GetService("ReplicatedStorage").BuyFS:InvokeServer("Blackleg")
end)
-----------------------------------------
	page5:Label("Sever Misc")
	
	page5:Button("HopServer",function()
	    Teleport()
	end)
	
	page5:Button("Hop LowServer",function()
	    HopLowerServer()
	end)
	...
	page5:Toggle("AutoHaki",false,function(vu)
	    _G.AutoHaki = vu
        spawn(function()
            while wait(0.2) do
                if _G.AutoHaki then
                    if game.Players.LocalPlayer.Character:FindFirstChild("Buso") then
                    else
                        game:GetService("ReplicatedStorage").Haki:FireServer("Buso")
                    end
                end
    ...
    page5:Toggle("AutoKen",false,function(vu)
        _G.AutoKen = vu
        spawn(function()
            while wait(0.2) do
                if _G.AutoKen then
                    pcall(function()
                    if game:GetService("Players").LocalPlayer.PlayerGui.ocean.FrameKenhaki.Visible == false then
	...
	page5:Toggle("Fly",false,function(value)
	    _G.Fly = value
	    spawn (function()
	        if _G.Fly then
    ...
    _G.Speed = 5
	local FlySpeedb = page5:Slider("Fly Speed 5 - 500",false,false,0, 500, _G.Speed, _G.Speed,false,function(value)
		_G.Speed = value
	end)
    ...
    while wait(0.2) do
        if _G.Shisui then 
            if game.Players.LocalPlayer.PlayerStats.Experience.Value >= 10 then
                ...
                game:GetService("ReplicatedStorage").BuyMysterious:InvokeServer("Shushi",false)
                wait(5)
                game.Players.LocalPlayer:Kick("ได้ดาบแล้วครับ")
            elseif game.Players.LocalPlayer.PlayerStats.Experience.Value < 10 then
                _G.SelectBoss = "TreeMoster"
